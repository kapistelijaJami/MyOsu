...
public class RenderText {
	...
	protected static Font defaultFont = new Font("Serif", Font.BOLD, 25);
	...
	public static void drawStringWithAlignment(Graphics2D g, String text, Rectangle rect, Font font) {
		drawStringWithAlignment(g, text, rect, font, Alignment.CENTER);
	}
	
	public static void drawStringWithAlignment(Graphics2D g, String text, Rectangle rect, Font font, Alignment align) {
		drawStringWithAlignment(g, text, rect, font, align, Alignment.CENTER);
	}
	
	public static void drawStringWithAlignment(Graphics2D g, String text, Rectangle rect, Font font, Alignment align, Alignment align2) {
		font = checkIfFontIsNull(font);
		FontMetrics metrics = g.getFontMetrics(font);
		int x = rect.x + (rect.width - metrics.stringWidth(text)) / 2; //These are already centered
		int y = rect.y + rect.height / 2 + getFontHeight(g, font) / 2;
